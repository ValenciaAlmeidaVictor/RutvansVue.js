...
class DestinoIntermedioTable extends DataTableComponent
{
    protected $model = DestinoIntermedio::class;
    ...
    public function viewModal($destinoIntermedioId): void
    {
        $this->dispatch('openDestinoIntermedioModal', destinoIntermedioId: $destinoIntermedioId)->to('destino-intermedio-component');
    }

    public function viewShowModal($destinoIntermedioId): void
    {
        $this->dispatch('openShowDestinoIntermedioModal', destinoIntermedioId: $destinoIntermedioId)->to('destino-intermedio-component');
    }

    public function deleteDestinoIntermedioTable($destinoIntermedioId): void
    {
        $this->dispatch('borrarRegistro', destinoIntermedioId: $destinoIntermedioId)->to('destino-intermedio-component');
    }
                ...
                ->buttons([
                    ...
                    LinkColumn::make('Delete')
                        ...
                        ->attributes(fn($row) => [
                            ...
                            'wire:click.prevent' => 'deleteDestinoIntermedioTable(' . $row->id . ')',
                        ])
                        ->html(),
                ])
        ];
